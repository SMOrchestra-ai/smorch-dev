---
name: mena-mobile-check
description: |
  MENA mobile 375px + cultural correctness checker. 10-point checklist covering viewport, touch targets, dates DD/MM/YYYY, currencies AED/SAR/QAR/KWD, Fri/Sat weekend, phone format, imagery. Caps UX hat at 6 if not tested.
---
