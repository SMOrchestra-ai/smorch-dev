...
description: |
  Per-project .claude/lessons.md self-improvement loop. Captures corrections as rules tied to rubric questions. Auto-loaded at SessionStart. Quarterly pruning of stale lessons.
---
