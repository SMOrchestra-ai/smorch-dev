...
2. Router resolves topic:
   ...
   - **`next`** → context-aware recommendation (reads latest `docs/qa-scores/`, `docs/handovers/`, `docs/qa/`, `.smorch/project.json`, current branch/PR state — outputs the next command to run)
...
/smo-dev-guide next                # "you just scored 94. Run /smo-handover."
